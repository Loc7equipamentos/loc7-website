...
export default function AdminUsuarios() {
  ...
  return (
    <div className="min-h-screen bg-[#07101c] px-6 py-10 text-[#111827]">
        ...
        <section className="rounded-2xl bg-white p-7 shadow-2xl">
          ...
          <form onSubmit={createUser} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={saving}
              className="mt-2 w-full rounded-lg bg-black py-3 text-sm font-semibold text-white transition hover:scale-[1.01] hover:brightness-110 disabled:opacity-60"
            >
        ...
        <section className="rounded-2xl bg-white p-7 shadow-2xl">
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[760px] text-left text-sm">
              <thead>
                <tr className="rounded-lg bg-gray-100 text-black">
                      ...
                      <td className="px-4 py-4">
                        <div className="flex justify-end gap-3">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1 rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold text-white transition hover:bg-red-700"
                          >
                            <Trash2 size={14} />
                            Excluir
                          </button>
