...
<section className="relative overflow-hidden bg-black">
  ...
  <div className="absolute inset-0 hidden md:block">
    ...
    <div className="absolute inset-x-0 bottom-0 h-[320px] bg-gradient-to-t from-black via-black/85 to-transparent" />
  </div>
  ...
  <div className="relative z-10 hidden md:block">
    {/* HERO CONTENT */}
    <div className="container flex h-[560px] items-start pt-32 lg:pt-36">
      <div className="max-w-[560px]">
        <p className="mb-3 text-[11px] font-medium uppercase tracking-[0.22em] text-white/65">
          LOCAÇÃO DE EQUIPAMENTOS AUDIOVISUAIS
        </p>
  ...
  {/* MOBILE DESTAQUES */}
  <div className="relative z-10 bg-black py-10 md:hidden">
