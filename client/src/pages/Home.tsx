...
export default function Home() {
  ...
  return (
    <div className="bg-black text-white">
      {/* HERO */}
      <section className="relative min-h-screen flex items-start md:items-start justify-center md:justify-start text-center md:text-left px-6 pt-12 md:pt-16 pb-0 overflow-hidden">
        <video
          autoPlay
          muted
          loop
        ...
        <div
          className={`max-w-5xl relative z-10 mt-0 transition-all duration-700 ease-out ${
