                ...
                <div className="relative overflow-hidden aspect-square bg-[oklch(0.08_0_0)]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-3 gap-2">
                    {productLink && (
                      <a
                        href={productLink}
                        className="flex-1 loc7-btn-primary text-xs py-2 text-center flex items-center justify-center gap-2"
                      >
                        Ver detalhes
                      </a>
                    )}
                    <a
                      ...
                      className={`${productLink ? 'flex-1' : 'w-full'} loc7-btn-primary text-xs py-2 text-center flex items-center justify-center gap-2`}
                    >
