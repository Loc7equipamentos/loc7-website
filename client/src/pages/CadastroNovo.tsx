            ...
            <>
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm mb-2">Nome do pai</label>
                    <input
                      name="nomePai"
                      className="w-full rounded-xl bg-white px-4 py-3 text-black outline-none"
                  ...
                  <div>
                    <label className="block text-sm mb-2">Estudante</label>
                    <select
                      name="estudante"
                      className="w-full rounded-xl bg-white px-4 py-3 text-black outline-none"
                    >
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <h2 className="text-xl font-semibold mb-4">5. Informações profissionais</h2>

                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm mb-2">Ocupação profissional</label>
                    <input
                      name="ocupacao"
                      className="w-full rounded-xl bg-white px-4 py-3 text-black outline-none"
                  ...
                  <div>
                    <label className="block text-sm mb-2">Pertence a associação</label>
                    <input
                      name="pertenceAssociacao"
                      className="w-full rounded-xl bg-white px-4 py-3 text-black outline-none"
                      placeholder="Ex: ABRACI, ABPITV..."
                    />
                  </div>

                  <div>
                    <label className="block text-sm mb-2">Qual associação</label>
                    <input
                      name="qualAssociacao"
                      className="w-full rounded-xl bg-white px-4 py-3 text-black outline-none"
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <h2 className="text-xl font-semibold mb-4">6. Referências comerciais</h2>
              ...
              <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <h2 className="text-xl font-semibold mb-4">7. Documentos</h2>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm mb-2">CPF ou CNH</label>
                    <input
                      type="file"
                      name="documentoCpfPf"
                      accept=".pdf,.jpg,.jpeg,.png"
