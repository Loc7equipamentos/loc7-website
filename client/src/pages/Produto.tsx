      ...
      <div className="container py-6 lg:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          ...
          <div className="flex flex-col justify-start">
            ...
            <h1 className="text-2xl lg:text-3xl font-semibold text-gray-900 mb-5 leading-tight">
              {product.name}
            </h1>
            ...
            {includesArray.length > 0 && (
              <div className="mb-6 pb-5 border-b border-gray-100">
                <h2 className="text-xs font-medium text-gray-600 uppercase tracking-wider mb-3">
                  O que acompanha
                </h2>
            ...
            <a
              ...
              className="w-full bg-black hover:bg-gray-900 text-white font-medium py-3 px-6 rounded transition flex items-center justify-center gap-2 text-base shadow-sm hover:shadow-md mb-6"
            >
