      ...
      <div className="container max-w-4xl">
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as FormType)}>
          ...
          <TabsContent value="pj">
            <form onSubmit={(e) => { e.preventDefault(); alert('Cadastro PJ enviado com sucesso!'); }} className="space-y-8">
              ...
              <div className="bg-white/5 border-2 border-white/10 p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormField label="UF" name="ufEntrega" type="select" value={pjData.ufEntrega} onChange={handlePJChange} options={estados.map(e => ({ value: e, label: e }))} />
                </div>
              </div>
