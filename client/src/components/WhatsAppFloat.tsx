 ...
 * Fixed bottom-right floating button with chatbot bubble
 */
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      {isChatOpen && (
        <div className="w-80 bg-[oklch(0.1_0_0)] border border-[oklch(0.22_0_0)] rounded-lg shadow-2xl shadow-black/70 overflow-hidden animate-fade-in-up">
          ...
          <div className="border-t border-[oklch(0.18_0_0)] p-3">
            <a
              href="https://wa.me/5511999999999?text=Olá! Vim pelo site e gostaria de um orçamento."
              target="_blank"
      ...
      <button
        ...
        className="w-14 h-14 bg-[#25D366] hover:bg-[#1ebe5a] rounded-full flex items-center justify-center shadow-lg shadow-black/50 transition-all hover:scale-110 active:scale-95"
      >
        {isChatOpen ? (
