...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-[calc(1.5rem+4cm)] right-[calc(1.5rem+4cm)] z-50 flex flex-col items-end gap-3">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 w-20 h-20 md:w-24 md:h-24 bg-[#25D366] rounded-full animate-pulse opacity-40" />
        ...
        <button
          ...
          className="relative w-20 h-20 md:w-24 md:h-24 bg-[#25D366] hover:bg-[#1ebe5a] rounded-full flex items-center justify-center shadow-2xl shadow-black/60 transition-all hover:opacity-90 active:scale-95 z-10"
          title="Posso ajudar?"
        >
          {isChatOpen ? (
