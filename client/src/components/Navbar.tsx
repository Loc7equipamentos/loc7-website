  ...
  {loadingCategories ? (
                          ...
                          dropdownCategories.map((cat) => (
                            <Link
                              key={cat.name}
                              href={cat.href}
                             className="block px-4 py-2 text-center text-xs font-medium tracking-wide text-white/70 transition-all duration-150 hover:scale-[1.05] hover:bg-white/[0.08] hover:text-white"
                            >
                              {cat.name}
                            </Link>
                          ))
